        ...
        $("#contactForm").on('submit', function(e) {
            ...
            if (required === 0)
            {
                $.ajax({
                    ...
                    data: {
                        'key': 'KjuI8cndRCfLJQAvpjquOA',
                        "message": {
                            "from_email":"hola@thermy.com.mx",
                            "to":[{"email":"hola@thermy.com.mx"}],
                            "subject": "Contacto de Thermy",
                            "html": "<p>\
                                Hola equipo Thermy, han recibido un correo electronico de " + con_name + " con los siguientes datos\
                                <strong>Teléfono: </strong> " + con_phone + " \
                                <strong>Correo Electrónico: </strong> " + con_email + " \
                                <strong>Empresa: </strong> " + con_company + " \
                                <strong>Mensaje: </strong> " + con_message + " \
                                </p>",
                            "autotext": true,
                            "track_opens": true,
                            "track_clicks": true
